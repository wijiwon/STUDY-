...
function fun(){
    ...
    // for문에 선언한 var 변수는 함수의 어디서든 접근이 가능하다
...
function fun2(){
    ...
    // 호출이 됨 접근됨 var 함수 스코프고
    console.log(a);
    // 호출이 안됨 접근안됨 let 블록 스코프
    console.log(b);
}
...
// fun4 함수가 fun3 함수의 value변수를 참조하고 fun4함수가 실행되면
// value를 선언 -> fun4함수는 fun3의 실행 컨텍스트에 생성된 value값을 변경 할수있다.

// 자바스크립트가 함수를 생성할때 함수나 변수 선언 위치를 기억해서
